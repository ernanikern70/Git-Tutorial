...
![GitHub Release](https://img.shields.io/github/v/release/ernanikern70/Git-Tutorial.git)[Repo size](https://img.shields.io/github/repo-size/ernanikern70/Git-Tutorial.git?label=Repo%20size&style=flat-round) ![GitHub branch status](https://img.shields.io/github/checks-status/ernanikern70/Git-Tutorial/main) ![GitHub stars](https://img.shields.io/github/stars/ernanikern70/Git-Tutorial.git?label=Stars&style=flat-round&color=yellow) ![Last commit](https://img.shields.io/github/last-commit/ernanikern70/Git-Tutorial.git?label=Last%20commit&style=flat-round&color=green) ![Open Issues](https://img.shields.io/github/issues/ernanikern70/Git-Tutorial.git?style=flat-round&color=red) ![Open PRs](https://img.shields.io/github/issues-pr/ernanikern70/Git-Tutorial.git?style=flat-round&color=orange) ![Latest Release](https://img.shields.io/github/v/release/ernanikern70/Git-Tutorial.git?style=flat-round&color=brightgreen)                                                                 
<!--
" }}}
-->
<!--
